          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <Link to="/" className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold text-foreground">LeadGen Pro</span>
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 mb-4 max-w-md">
                Transform your business with data-driven digital marketing strategies that generate qualified leads and drive growth.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li>hello@leadgenpro.com</li>
                <li>+1 (555) 123-4567</li>
                <li>123 Business Ave<br />Suite 100, City, ST 12345</li>
              </ul>
            </div>
          </div>
